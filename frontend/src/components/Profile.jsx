      ...
      <div className="max-w-4xl mx-auto bg-white border-gray-200 rounded-2xl my-5 p-8">
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
          ...
          {user?.profile?.resume ? (
            ...
            <span 
              onClick={() => setOpen(true)} 
              className="text-indigo-600 font-bold hover:underline cursor-pointer flex items-center gap-1 mt-1 transition-all"
            >
              No resume uploaded. Click here to upload yours.
            </span>
          )}
        </div>
